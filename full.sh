...
curl -L https://github.com/sidazhang/server/blob/master/modules/postgres.sh | sh
curl -L https://raw.github.com/sidazhang/server/master/modules/ruby.sh | sh
curl -L https://raw.github.com/sidazhang/server/master/modules/ruby_gems.sh | sh
